...
const archiveData = [
    { 
        ...
        thumbnailVideo: "FOOTAGE/VIDEO/THUMBNAIL/thumbnail.mp4",
        link: "ISSUE3.html" 
    },
    { 
        title: "RANDOM 2025", 
    ...
    { 
        ...
        thumbnailVideo: "FOOTAGE/VIDEO/THUMBNAIL/issue2thumbnail.mp4",
        link: "ISSUE2.html" 
    },
    ...
    { 
        ...
        thumbnailVideo: "FOOTAGE/VIDEO/THUMBNAIL/UNITTEASER.mp4",
        link: "UN1T.html" 
    }
...
function generateArchive() {
    ...
    sortedYears.forEach(year => {
        ...
        yearSection.innerHTML = `<h3 class="archive-year">${year}</h3>`;

        grouped[year].forEach(item => {
            const post = document.createElement("div");
            post.classList.add("archive-item");

            // Thumbnail can be an image or video
            let mediaElement;
            if (item.thumbnailVideo) {
                mediaElement = document.createElement("video");
                mediaElement.src = item.thumbnailVideo;
                mediaElement.autoplay = true;
                mediaElement.loop = true;
                mediaElement.muted = true;
                mediaElement.classList.add("archive-thumbnail");
            } else {
            ...
            infoContainer.classList.add("archive-info");
            ...
            content.classList.add("archive-content", "hidden");
            ...
            infoContainer.appendChild(viewMore);

            post.appendChild(mediaElement);
            post.appendChild(infoContainer);

            yearSection.appendChild(post);
        });
